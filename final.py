...
# Name = StringVar()
# NameEn = Entry(root, textvariable=Name,bg='#8DBF5A',font=('Times', 21))
# NameEn.grid(row=6, column=0,font=('Times', 21))
...
# textfileds
t1 = Text(root, height=1, width=25, bg="white",
          fg="black", font=('Times', 21),)
t1.grid(row=15, column=0, pady=10, padx=35)

t2 = Text(root, height=1, width=25, bg="white",
          fg="black", font=('Times', 21),)
