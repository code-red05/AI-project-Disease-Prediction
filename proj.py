...
Label(
    ...
    font=('Times', 21),
    text='Symptom 1 '
).grid(row=7, column=0, pady=10, padx=10, sticky=W)

Symptom1 = AutocompleteCombobox(
    width=25,
    font=('Times', 18),
    completevalues=symptoms
)
Symptom1.grid(row=7, column=0)
...
Label(
    ...
    font=('Times', 21),
    text='Symptom 2 '
).grid(row=8, column=0, pady=10, padx=10, sticky=W)

Symptom2 = AutocompleteCombobox(
    width=25,
    font=('Times', 18),
    completevalues=symptoms
)
Symptom2.grid(row=8, column=0)
...
Label(
    ...
    font=('Times', 21),
    text='Symptom 3 '
).grid(row=9, column=0, pady=10, padx=10, sticky=W)

Symptom3 = AutocompleteCombobox(
    width=25,
    font=('Times', 18),
    completevalues=symptoms
)
Symptom3.grid(row=9, column=0)
...
Label(
    ...
    font=('Times', 21),
    text='Symptom 4 '
).grid(row=10, column=0, pady=10, padx=10, sticky=W)

Symptom4 = AutocompleteCombobox(
    width=25,
    font=('Times', 18),
    completevalues=symptoms
)
Symptom4.grid(row=10, column=0)
...
Label(
    ...
    font=('Times', 21),
    text='Symptom 5 '
).grid(row=11, column=0, pady=10, padx=10, sticky=W)

Symptom5 = AutocompleteCombobox(
    width=25,
    font=('Times', 18),
    completevalues=symptoms
)
Symptom5.grid(row=11, column=0)
...
dst = Button(root, text="DecisionTree", command=DecisionTree,
             font=('Times', 15), fg="black")
dst.grid(row=8, column=1, padx=10)

rnf = Button(root, text="Naive Bayes", command=NaiveBayes,
             font=('Times', 15), fg="black")
rnf.grid(row=9, column=1, padx=10)

bst = Button(root, text="Gradient Boosting", command=GradientBoosting,
             font=('Times', 15), fg="black")
bst.grid(row=10, column=1, padx=10)


restart_program_button = Button(
    root, text="Restart_program", font=('Times', 15), command=Restart)
restart_program_button.grid(row=11, column=1, padx=10)

# ----------------------------------------------------------------------------------
lrLb = Label(root, text="Decision Tree", fg="black",
             bg='#44BF3A',    font=('Times', 21))
lrLb.grid(row=15, column=0, pady=10, padx=10, sticky=W)

destreeLb = Label(root, text="Naive Bayes", fg="black",
                  bg='#44BF3A',    font=('Times', 21))
destreeLb.grid(row=16, column=0, pady=10, padx=10, sticky=W)

boost = Label(root, text="Gradient Boost", fg="black", bg="#44BF3A", font=('Times', 21))
boost.grid(row=17, column=0, pady=10, padx=10, sticky=W)
# ----------------------------------------------------------------------------------

# textfileds
t1 = Text(root, height=1, width=20, bg="white",
          fg="black", font=('Times', 21),)
t1.grid(row=15, column=0, pady=10, padx=55)

t2 = Text(root, height=1, width=20, bg="white",
          fg="black", font=('Times', 21),)
t2.grid(row=16, column=0, pady=10, padx=55)

t3 = Text(root, height=1, width=20,bg="white",fg="black", font=('Times', 21))
t3.grid(row=17, column=0 , pady=10, padx=55)
