...
S1Lb.grid(row=7, column=0, pady=10, padx=20, sticky=W)

S2Lb = Label(root, text="Symptom 2", fg="white", bg="black")
S2Lb.grid(row=8, column=0, pady=10, padx=20, sticky=W)

S3Lb = Label(root, text="Symptom 3", fg="white", bg="black")
S3Lb.grid(row=9, column=0, pady=10, padx=20, sticky=W)
...
lrLb.grid(row=15, column=0, pady=10, padx=20, sticky=W)


destreeLb = Label(root, text="RandomForest", fg="black", bg="white")
destreeLb.grid(row=17, column=0, pady=10, padx=20, sticky=W)
...
dst = Button(root, text="DecisionTree", command=DecisionTree, fg="black")
dst.grid(row=8, column=1, padx=10)

rnf = Button(root, text="Randomforest", command=randomforest, fg="black")
rnf.grid(row=9, column=1, padx=10)

restart_program_button = Button(root, text="Restart_program", command=Restart)
